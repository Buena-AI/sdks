...
const sdkdefaulterror_js_1 = require("../models/errors/sdkdefaulterror.js");
...
function match(...matchers) {
    return async function matchFunc(response, request, options) {
        ...
        if (!matcher) {
            return [{
                    ok: false,
                    error: new sdkdefaulterror_js_1.SDKDefaultError("Unexpected Status or Content-Type", {
                        response,
                        request,
        ...
        if (matcher.enc === "fail") {
            return [{
                    ok: false,
                    error: new sdkdefaulterror_js_1.SDKDefaultError("API error occurred", {
                        request,
                        response,
                        body,
                    }),
