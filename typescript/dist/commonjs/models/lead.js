...
exports.Lead$ = exports.Lead$outboundSchema = exports.Lead$inboundSchema = exports.Status$ = exports.Status$outboundSchema = exports.Status$inboundSchema = exports.Status = void 0;
...
/** @internal */
exports.Lead$outboundSchema = z.object({
    id: z.string().optional(),
...
(function (Lead$) {
    ...
    Lead$.inboundSchema = exports.Lead$inboundSchema;
    /** @deprecated use `Lead$outboundSchema` instead. */
    Lead$.outboundSchema = exports.Lead$outboundSchema;
})(Lead$ || (exports.Lead$ = Lead$ = {}));
function leadToJSON(lead) {
    return JSON.stringify(exports.Lead$outboundSchema.parse(lead));
}
function leadFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.Lead$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Lead' from JSON`);
}
